...
import Icon from "../../public/assets/AlphaMenLogo.jpeg";
import Tiktok from "../../public/assets/tiktok_logo.png";
import Instagram from "../../public/assets/instagram_logo.png";
import WhatsApp from "../../public/assets/whatsapp_logo.png";
import { Link } from "react-router-dom";
function Home() {
  return (
    <div className=" h-full-Screen bg-white  flex justify-center">
      <div className="flex flex-col pt-24 items-center mss:w-full p-3">
        <img src={Icon} alt="icon" className="rounded-full size-32 mb-7" />
        <h3 className="font-bold pb-3 ">AlphaMen Barbershop</h3>
        <h3 Barbershop>AlphaMen Barbershopברוכים הבאים ל</h3>
        <h1 id="socials" className="flex gap-2 py-3">
          <a
        ...
        <div id="Comment">
          <p className="text-end text-sm border-2 border-blue-300 border-dashed rounded-md max-w-lg p-2">
            <h1 className="font-bold">:שימו לב</h1>
        ...
        <hr className="w-full border-t border-gray-300 my-4 max-w-lg" />
        <div id="contacts"></div>
        <div className="w-full flex flex-row-reverse justify-around text-end text-[13px]">
