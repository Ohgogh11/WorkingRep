...
function Navbar2() {
  ...
  return (
    <header className="header bg-[#161b22] text-white py-4 text-sm font-mono">
      ...
      {/* DynamicNav */}
      <div className="DynamicNav hidden mlg:flex justify-between items-center px-10">
        <IsSignedIn
          logged={
            <div className='w-20'>
              <SignOut to='/Login' className="border rounded-md border-white px-2 py-1 flex items-center">Sign Out</SignOut>
            </div>
          }
          notLogged={
            <div className=" w-20">
